  ...
  return (
    <li className="flex flex-row items-center justify-between bg-foreground py-4 px-8 rounded-lg">
      <p className="font-bold">
        <span className="text-primary/70">#</span>RT3080
      </p>
      <p className="font-light text-primary/70">Due 19 Aug 2021</p>
      <p className="font-light text-primary/70">Jensen Huang</p>
